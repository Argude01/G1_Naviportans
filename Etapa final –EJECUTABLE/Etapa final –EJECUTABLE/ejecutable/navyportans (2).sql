...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 28-08-2021 a las 05:37:06
...
INSERT INTO `tbl_productos` (`ID_PRODUCTO`, `Descripcion`, `Precio`, `Id_categoria`) VALUES
(45, '1 pizza,2 hambueguesa,3 tacos,4 camarones, ', 1410, 1),
(78, '1 pizza,0 hambueguesa,0 tacos,0 camarones  ', 150, 1),
(79, '1 pizza,0 hambueguesa,0 tacos,0 camarones  ', 150, 1);
...
(7, 'javierf89', 'cruzjostin987@gmail.com', 'javier2003', 'honduras'),
(15, 'jostin', 'jostin1@gmail.com', '78', 'barrio abajo');
...
--
ALTER TABLE `tbl_productos`
  MODIFY `ID_PRODUCTO` int(200) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=82;
